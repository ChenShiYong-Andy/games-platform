...
export async function getData<T>(url: string, params?: Record<string, unknown>, timeout?: number): Promise<T> {
  const res = await api.get<ApiResponse<T>>(url, { params, timeout })
