...
public final class ChineseChessRules {
     ...
     * 中国象棋棋盘行数。
     */
    @Schema(description = "中国象棋棋盘行数")
    public static final int ROWS = 10;
    /**
     * 中国象棋棋盘列数。
     */
    @Schema(description = "中国象棋棋盘列数")
    public static final int COLS = 9;
    /**
     * 车的棋子类型编号。
     */
    @Schema(description = "车的棋子类型编号")
    public static final int ROOK = 1;
    /**
     * 马的棋子类型编号。
     */
    @Schema(description = "马的棋子类型编号")
    public static final int HORSE = 2;
    /**
     * 象的棋子类型编号。
     */
    @Schema(description = "象的棋子类型编号")
    public static final int ELEPHANT = 3;
    /**
     * 士的棋子类型编号。
     */
    @Schema(description = "士的棋子类型编号")
    public static final int ADVISOR = 4;
    /**
     * 将帅的棋子类型编号。
     */
    @Schema(description = "将帅的棋子类型编号")
    public static final int GENERAL = 5;
    /**
     * 炮的棋子类型编号。
     */
    @Schema(description = "炮的棋子类型编号")
    public static final int CANNON = 6;
    /**
     * 兵卒的棋子类型编号。
     */
    @Schema(description = "兵卒的棋子类型编号")
    public static final int PAWN = 7;


    /**
     * 创建ChineseChessRules实例。
     */
